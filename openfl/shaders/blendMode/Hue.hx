 ...
 * @author Loudo
 */
class Hue extends GraphicsShader
{
	...
	@:glFragmentSource(
		...
		void main(void) {
			...
			vec3 blendedColor = blendHue(bgColor.rgb, fgColor.rgb, fgColor.a);
